...
// const fs = require('fs');
// // require('./public/')
// var x = fs.readFile('./public/Screenshot_1663334179.png','base64');
...
export const aes_en = async(message, key) => {
    // var EncodingAESKey="1a34567890123456789012345678901234567890123"
    // message="中华人民共和国"
    var EncodingAESKey = key;
    const enstr = AES.encrypt(EncodingAESKey,message)
    // console.log( enstr )
    // console.log ( AES.decrypt( EncodingAESKey, enstr ))
    return AES.decrypt( EncodingAESKey, enstr );
}
